class Excel {
    ...
    constructor(height: number, width: string) {
        ...
        this.sumMap = new Map<string, string[]>();
        let initialLetter = 'A';
        for(let i = 1; i <= height; i++){
            while(initialLetter !== width){
                this.map.set(initialLetter + i.toString(), 0);
                this.children.set(initialLetter + i.toString(), new Set<string>());
            ...
            this.children.set(initialLetter + height.toString(), new Set<string>());
