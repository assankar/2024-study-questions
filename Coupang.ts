...
function createUserSiteMap(input: string[][], input2: string[][]){
    let userSiteMap:Map<string, Map<string,string>> = new Map<string, Map<string,string>>();
    
    let fans: Map<string, Set<string>> = new Map<string, Set<string>>();
